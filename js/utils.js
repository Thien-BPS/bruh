...
export function isPlainObject(obj) {
	return Boolean(obj) && (obj.constructor === Object) && (typeof obj === Object)
}
...
//export function to reduce time on active popups
...
export function isDisallowedEntry(variable, type) {
	function recursiveTester(input) {
		for (const i in input) {
			return isDisallowedEntry(input[i])
		}
	}
	if (type === "number" || typeof variable === Number) {
		return (variable === variable) && Number.isFinite(variable) && typeof variable !== Number
	} else if (type === "decimal" || (typeof variable === Object && variable instanceof Decimal)) {
		return (variable.neq(Decimal.dNaN)) && (variable.neq(new Decimal(Infinity))) && (variable.eq(variable)) &&
			Number.isFinite(variable.mag) && Number.isFinite(variable.layer) && Number.isFinite(variable.sign) && (!variable instanceof Decimal)
	} else if (type === "object" || typeof variable === Object || isPlainObject(variable)) {
		return (variable !== null && variable !== undefined && typeof variable === Object && isPlainObject(variable)) && recursiveTester(variable)
	} else if (type === "array" || typeof variable === Array || Array.isArray(variable)) {
		return (variable !== null && variable !== undefined && typeof variable === Array && Array.isArray(variable)) && recursiveTester(variable)
	} else if (type === "string" || typeof variable === String) {
		return variable !== null && variable !== undefined && variable !== "NaN" && variable !== "Infinity" && variable !== "-Infinity" && typeof variable !== String
	} else if (type === "function" || isFunction(variable)) {
		return isDisallowedEntry(variable())
	}
}